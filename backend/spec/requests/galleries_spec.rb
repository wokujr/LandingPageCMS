...
RSpec.describe "/galleries", type: :request do
  ...
  # GalleriesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get galleries_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Gallery" do
        expect {
          post galleries_url,
               params: { gallery: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Gallery" do
        expect {
          post galleries_url,
               params: { gallery: invalid_attributes }, as: :json
        }.to change(Gallery, :count).by(0)
      end

      it "renders a JSON response with errors for the new gallery" do
        post galleries_url,
             params: { gallery: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested gallery" do
        ...
        patch gallery_url(gallery),
              params: { gallery: new_attributes }, headers: valid_headers, as: :json
        gallery.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested gallery" do
      gallery = Gallery.create! valid_attributes
      expect {
        delete gallery_url(gallery), headers: valid_headers, as: :json
      }.to change(Gallery, :count).by(-1)
    end
  end
end
